...
SQL Murder Mystery: investigación de un caso mediante consultas
SQL sobre una base de datos SQLite.

Modelo de datos para e-commerce: diseño normalizado hasta 3NF,
...
La relación entre orders y products es N: un pedido puede
...
conectarse al proyecto de Google Cloud;

localizar el dataset;

crear las siete tablas;

definir los esquemas y tipos de datos.
...
construye la referencia de la tabla;

utiliza load_table_from_dataframe;

espera a que finalice el proceso de carga;

recupera la tabla cargada;

muestra el número de filas cargadas;

captura errores mediante try/except.
...
Visual Studio Code o Jupyter

Entorno virtual venv

Las dependencias Python se encuentran en:
